...
export interface Task {
  ...
  created_at: string;
  updated_at: string;
  // Enhanced methodology fields (optional for legacy compatibility)
  methodology_type?: 'bmad' | 'sage' | 'archon' | 'general';
  validation_status?: 'pending' | 'passed' | 'failed';
  command_source?: string;
  metadata?: string; // JSON string for backward compatibility
}
